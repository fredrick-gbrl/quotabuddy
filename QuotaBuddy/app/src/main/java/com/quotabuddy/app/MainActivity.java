...
public class MainActivity extends Activity {
    ...
    private void showPayments(){currentTab="payments";screen("Pagamenti","Ogni movimento è modificabile o eliminabile",false,null,"+",()->paymentDialog(null,null,null),true);
        ...
        boolean[] personReady={false};personSpin.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener(){public void onItemSelected(android.widget.AdapterView<?> a,View v,int pos,long id){if(!personReady[0]){personReady[0]=true;return;}filterPersonId=pos==0?null:people.get(pos-1).id;showPayments();}public void onNothingSelected(android.widget.AdapterView<?> a){}});
        ...
        boolean[] subReady={false};subSpin.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener(){public void onItemSelected(android.widget.AdapterView<?> a,View v,int pos,long id){if(!subReady[0]){subReady[0]=true;return;}filterSubId=pos==0?null:subs.get(pos-1).id;showPayments();}public void onNothingSelected(android.widget.AdapterView<?> a){}});
